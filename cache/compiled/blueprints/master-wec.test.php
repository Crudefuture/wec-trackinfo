...
return [
    ...
    'timestamp' => 1728601050,
    'checksum' => '47690037a79dd0070998e0f770a8bb30',
    'files' => [
        ...
        'user/themes' => [
            'themes/fiawec' => [
                'file' => 'user/themes/fiawec/blueprints.yaml',
                'modified' => 1728415404
            ],
            'themes/quark' => [
    ...
    'data' => [
        'items' => [
            ...
            'themes.fiawec.production-mode' => [
                ...
                'name' => 'themes.fiawec.production-mode',
                'validation' => 'loose'
            ],
            'themes.fiawec.grid-size' => [
                'type' => 'select',
                ...
                'name' => 'themes.fiawec.grid-size',
                'validation' => 'loose'
            ],
            'themes.fiawec.custom_logo' => [
                'array' => true,
                'media_field' => true,
                'validate' => [
                    'type' => 'ignore'
                ...
                'name' => 'themes.fiawec.custom_logo',
                'validation' => 'loose'
            ],
            'themes.fiawec.custom_logo_mobile' => [
                'array' => true,
                'media_field' => true,
                'validate' => [
                    'type' => 'ignore'
                ...
                'name' => 'themes.fiawec.custom_logo_mobile',
                'validation' => 'loose'
            ],
            'themes.fiawec.header-fixed' => [
                'type' => 'toggle',
                'label' => 'Fixed header',
                'highlight' => 1,
                'default' => 1,
                ...
                'name' => 'themes.fiawec.header-fixed',
                'validation' => 'loose'
            ],
            'themes.fiawec.header-animated' => [
                'type' => 'toggle',
                'label' => 'Animated',
                'highlight' => 1,
                'default' => 1,
                ...
                'name' => 'themes.fiawec.header-animated',
                'validation' => 'loose'
            ],
            'themes.fiawec.header-dark' => [
                'type' => 'toggle',
                'label' => 'Dark Style',
                'highlight' => 0,
                'default' => 0,
                ...
                'name' => 'themes.fiawec.header-dark',
                'validation' => 'loose'
            ],
            'themes.fiawec.header-transparent' => [
                'type' => 'toggle',
                'label' => 'Transparent',
                'highlight' => 0,
                'default' => 0,
                ...
                'name' => 'themes.fiawec.header-transparent',
                'validation' => 'loose'
            ],
            'themes.fiawec.sticky-footer' => [
                'type' => 'toggle',
                'label' => 'Sticky footer',
                'highlight' => 1,
                'default' => 1,
                ...
                'name' => 'themes.fiawec.sticky-footer',
                'validation' => 'loose'
            ],
            'themes.fiawec.blog-page' => [
                'type' => 'text',
                'label' => 'Blog Page',
                'size' => 'medium',
                'default' => '/blog',
                'name' => 'themes.fiawec.blog-page',
                'validation' => 'loose'
            ],
            'themes.fiawec.spectre' => [
                'type' => '_parent',
                'name' => 'themes.fiawec.spectre',
                'form_field' => false
            ],
            'themes.fiawec.spectre.exp' => [
                'type' => 'toggle',
                ...
                'name' => 'themes.fiawec.spectre.exp',
                'validation' => 'loose'
            ],
            'themes.fiawec.spectre.icons' => [
                'type' => 'toggle',
                'label' => 'Icons CSS',
                'highlight' => 0,
                'default' => 0,
                ...
                'name' => 'themes.fiawec.spectre.icons',
                'validation' => 'loose'
            ],
            'themes.quark' => [
                'type' => '_root',
        ...
        'nested' => [
            ...
            'themes' => [
                'fiawec' => [
                    'production-mode' => 'themes.fiawec.production-mode',
                    'grid-size' => 'themes.fiawec.grid-size',
                    'custom_logo' => 'themes.fiawec.custom_logo',
                    'custom_logo_mobile' => 'themes.fiawec.custom_logo_mobile',
                    'header-fixed' => 'themes.fiawec.header-fixed',
                    'header-animated' => 'themes.fiawec.header-animated',
                    'header-dark' => 'themes.fiawec.header-dark',
                    'header-transparent' => 'themes.fiawec.header-transparent',
                    'sticky-footer' => 'themes.fiawec.sticky-footer',
                    'blog-page' => 'themes.fiawec.blog-page',
                    'spectre' => [
                        'exp' => 'themes.fiawec.spectre.exp',
                        'icons' => 'themes.fiawec.spectre.icons'
                    ]
                ],
                'quark' => [
